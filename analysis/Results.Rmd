...
df7$`LTBI testing to check eligibility of PLHIV to receive TPT` <- factor(df7$`LTBI testing to check eligibility of PLHIV to receive TPT`, levels = c("Interferon-Gamma Release Assays (IGRAs) blood test","Tuberculin Skin Test (TST)", "Both", "Other", "No"))
...
plhiv <- df7 %>% filter(who_group == "People living with HIV") %>% select(-record_id, -who_group)
