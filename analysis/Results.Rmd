...
df1 <- df %>%
  select(
    record_id, region, region_exact, tpt_eligible_adult___77:tpt_eligible_adult___88, tpt_lt12m, tpt_ge1y, tpt_g11y_tb, tpt_peds_lt5,
  ...
  pivot_longer(
    cols = 
      -c(record_id, region, region_exact, HBC_ANY, HBC_TB, HBC_TB_HIV, HBC_DR_TB, `Level of integration`, `Income Level`, `HIV Prevalence`, `LTBI testing`),
    names_to = "variable",
    values_to = "category")  %>% 
  mutate(
...
```{r}
df2 <- df %>% 
  select(record_id, region, region_exact, tpt_barriers___77:tpt_barriers___88, HBC_ANY, HBC_TB,
    HBC_TB_HIV, HBC_DR_TB, tbhiv_integration.factor, Income_group, Prev_cat.factor, ltbi_ligibility.factor) %>%
  rename(
  ...
  pivot_longer(cols = -c(record_id, region, region_exact, HBC_ANY, HBC_TB, HBC_TB_HIV, HBC_DR_TB, `Level of integration`, `Income Level`, `HIV Prevalence`, `LTBI testing`),
               names_to = "variable",
               values_to = "category") %>% 
...
df5 <- df %>% 
  select(record_id, inh6_b___1:other_specify_b___3, region, region_exact, HBC_ANY, HBC_TB,
  ...
  select(record_id, '6-month isoniazid (6H)':Other, region, region_exact, HBC_ANY, HBC_TB,
...
df5b <- df5 %>% 
  pivot_longer(
    cols = 
      -c(record_id, region, region_exact, HBC_ANY, HBC_TB, HBC_TB_HIV, HBC_DR_TB, `Level of integration`, 
...
ggsave("../results/fig5b.png", plot = fig5b, width = 18, height = 12, units = "cm", dpi = 300)
```
...
ggsave("../results/fig5a.png", plot = fig5a, width = 18, height = 12, units = "cm", dpi = 300)
```
...
ggsave("../results/fig5d.png", plot = fig5d, width = 18, height = 12, units = "cm", dpi = 300)
```
...
ggsave("../results/fig5c.png", plot = fig5c, width = 18, height = 12, units = "cm", dpi = 300)
```
